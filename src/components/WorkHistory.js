...
export class WorkHistory extends React.Component {
    render() {
        ...
        const triangleClass = (this.props.index % 2 === 0) ? 'timeline-content timeline-content-first p-3 p-lg-4 triangle-yellow' : 'timeline-content timeline-content-second p-3 p-lg-4 triangle-yellow'
        return (
            <>
